...
const CPU::Instruction CPU::PREFIXED_INSTRUCTION_MAP[] =
{
	...
	/* 0x20 */{ "<Unkown>", 1, 8, NULL },
	/* 0x21 */{ "<Unkown>", 1, 8, NULL },
	/* 0x22 */{ "<Unkown>", 1, 8, NULL },
	/* 0x23 */{ "<Unkown>", 1, 8, NULL },
	/* 0x24 */{ "<Unkown>", 1, 8, NULL },
	/* 0x25 */{ "<Unkown>", 1, 8, NULL },
	/* 0x26 */{ "<Unkown>", 1, 16, NULL },
	/* 0x27 */{ "<Unkown>", 1, 8, NULL },
	/* 0x28 */{ "<Unkown>", 1, 8, NULL },
	/* 0x29 */{ "<Unkown>", 1, 8, NULL },
	/* 0x2A */{ "<Unkown>", 1, 8, NULL },
	/* 0x2B */{ "<Unkown>", 1, 8, NULL },
	/* 0x2C */{ "<Unkown>", 1, 8, NULL },
	/* 0x2D */{ "<Unkown>", 1, 8, NULL },
	/* 0x2E */{ "<Unkown>", 1, 16, NULL },
	/* 0x2F */{ "<Unkown>", 1, 8, NULL },
	...
	/* 0x38 */{ "<Unkown>", 1, 8, NULL },
	/* 0x39 */{ "<Unkown>", 1, 8, NULL },
	/* 0x3A */{ "<Unkown>", 1, 8, NULL },
	/* 0x3B */{ "<Unkown>", 1, 8, NULL },
	/* 0x3C */{ "<Unkown>", 1, 8, NULL },
	/* 0x3D */{ "<Unkown>", 1, 8, NULL },
	/* 0x3E */{ "<Unkown>", 1, 16, NULL },
	/* 0x3F */{ "<Unkown>", 1, 8, NULL },

	/* 0x40 */{ "<Unkown>", 1, 8, NULL },
	/* 0x41 */{ "<Unkown>", 1, 8, NULL },
	/* 0x42 */{ "<Unkown>", 1, 8, NULL },
	/* 0x43 */{ "<Unkown>", 1, 8, NULL },
	/* 0x44 */{ "<Unkown>", 1, 8, NULL },
	/* 0x45 */{ "<Unkown>", 1, 8, NULL },
	/* 0x46 */{ "<Unkown>", 1, 16, NULL },
	/* 0x47 */{ "<Unkown>", 1, 8, NULL },
	/* 0x48 */{ "<Unkown>", 1, 8, NULL },
	/* 0x49 */{ "<Unkown>", 1, 8, NULL },
	/* 0x4A */{ "<Unkown>", 1, 8, NULL },
	/* 0x4B */{ "<Unkown>", 1, 8, NULL },
	/* 0x4C */{ "<Unkown>", 1, 8, NULL },
	/* 0x4D */{ "<Unkown>", 1, 8, NULL },
	/* 0x4E */{ "<Unkown>", 1, 16, NULL },
	/* 0x4F */{ "<Unkown>", 1, 8, NULL },

	/* 0x50 */{ "<Unkown>", 1, 8, NULL },
	/* 0x51 */{ "<Unkown>", 1, 8, NULL },
	/* 0x52 */{ "<Unkown>", 1, 8, NULL },
	/* 0x53 */{ "<Unkown>", 1, 8, NULL },
	/* 0x54 */{ "<Unkown>", 1, 8, NULL },
	/* 0x55 */{ "<Unkown>", 1, 8, NULL },
	/* 0x56 */{ "<Unkown>", 1, 16, NULL },
	/* 0x57 */{ "<Unkown>", 1, 8, NULL },
	/* 0x58 */{ "<Unkown>", 1, 8, NULL },
	/* 0x59 */{ "<Unkown>", 1, 8, NULL },
	/* 0x5A */{ "<Unkown>", 1, 8, NULL },
	/* 0x5B */{ "<Unkown>", 1, 8, NULL },
	/* 0x5C */{ "<Unkown>", 1, 8, NULL },
	/* 0x5D */{ "<Unkown>", 1, 8, NULL },
	/* 0x5E */{ "<Unkown>", 1, 16, NULL },
	/* 0x5F */{ "<Unkown>", 1, 8, NULL },
	
	/* 0x60 */{ "<Unkown>", 1, 8, NULL },
	/* 0x61 */{ "<Unkown>", 1, 8, NULL },
	/* 0x62 */{ "<Unkown>", 1, 8, NULL },
	/* 0x63 */{ "<Unkown>", 1, 8, NULL },
	/* 0x64 */{ "<Unkown>", 1, 8, NULL },
	/* 0x65 */{ "<Unkown>", 1, 8, NULL },
	/* 0x66 */{ "<Unkown>", 1, 16, NULL },
	/* 0x67 */{ "<Unkown>", 1, 8, NULL },
	/* 0x68 */{ "<Unkown>", 1, 8, NULL },
	/* 0x69 */{ "<Unkown>", 1, 8, NULL },
	/* 0x6A */{ "<Unkown>", 1, 8, NULL },
	/* 0x6B */{ "<Unkown>", 1, 8, NULL },
	/* 0x6C */{ "<Unkown>", 1, 8, NULL },
	/* 0x6D */{ "<Unkown>", 1, 8, NULL },
	/* 0x6E */{ "<Unkown>", 1, 16, NULL },
	/* 0x6F */{ "<Unkown>", 1, 8, NULL },

	/* 0x70 */{ "<Unkown>", 1, 8, NULL },
	/* 0x71 */{ "<Unkown>", 1, 8, NULL },
	/* 0x72 */{ "<Unkown>", 1, 8, NULL },
	/* 0x73 */{ "<Unkown>", 1, 8, NULL },
	/* 0x74 */{ "<Unkown>", 1, 8, NULL },
	/* 0x75 */{ "<Unkown>", 1, 8, NULL },
	/* 0x76 */{ "<Unkown>", 1, 16, NULL },
	/* 0x77 */{ "<Unkown>", 1, 8, NULL },
	/* 0x78 */{ "<Unkown>", 1, 8, NULL },
	/* 0x79 */{ "<Unkown>", 1, 8, NULL },
	/* 0x7A */{ "<Unkown>", 1, 8, NULL },
	/* 0x7B */{ "<Unkown>", 1, 8, NULL },
	/* 0x7C */{ "<Unkown>", 1, 8, NULL },
	/* 0x7D */{ "<Unkown>", 1, 8, NULL },
	/* 0x7E */{ "<Unkown>", 1, 16, NULL },
	/* 0x7F */{ "<Unkown>", 1, 8, NULL },
