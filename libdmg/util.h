...
#define WRITE_BYTE(dst, value) (*reinterpret_cast<uint8_t*>(dst) = (value))
#define WRITE_SBYTE(dst, value) (*reinterpret_cast<int8_t*>(dst) = (value))
#define WRITE_SHORT(dst, value) (*reinterpret_cast<uint16_t*>(dst) = (value))
#define WRITE_SSHORT(dst, value) (*reinterpret_cast<int16_t*>(dst) = (value))
#define WRITE_LONG(dst, value) (*reinterpret_cast<uint32_t*>(dst) = (value))
#define WRITE_SLONG(dst, value) (*reinterpret_cast<int32_t*>(dst) = (value))
